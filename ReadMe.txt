========================================================================
    KONSOLENANWENDUNG: 18_Telefonbuchserver (ABI 2007 A)-Projektübersicht
========================================================================

Diese 18_Telefonbuchserver (ABI 2007 A)-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 18_Telefonbuchserver (ABI 2007 A)-Anwendung besteht.


18_Telefonbuchserver (ABI 2007 A).vcxproj
...
18_Telefonbuchserver (ABI 2007 A).vcxproj.filters
...
18_Telefonbuchserver (ABI 2007 A).cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 18_Telefonbuchserver (ABI 2007 A).pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
